...
def test_run_fails_empty_cregs(adonis_architecture, adonis_static_architecture):
    ...
    when(client).get_static_quantum_architecture().thenReturn(adonis_static_architecture)
    backend = IQMFacadeBackend(client, use_metrics=False)

...
project = "IQM Qubit Selector"
author = "IQM Qubit Selector developers"
...
release = ""
try:
    from iqm.qubit_selector import __version__ as version
except ImportError:
    pass
else:
    release = version

copyright = "2022-2026, IQM Finland Oy, Release {}".format(release)
...
htmlhelp_basename = "iqm_qubit_selector-doc"
